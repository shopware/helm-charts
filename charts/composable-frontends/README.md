...
- [Composable Frontends GitHub repository](https://github.com/shopware/frontends)
...
This chart will deploy a Shopware Composable Frontends storefront in your Kubernetes cluster.
...
helm install my-frontend shopware/composable-frontends --namespace my-namespace --create-namespace
```

Checkout the [values.yaml](values.yaml) file to modify the deployment.
Change it to your needs and install it:

```sh
helm install frontend shopware/composable-frontends -f values.yaml
```
